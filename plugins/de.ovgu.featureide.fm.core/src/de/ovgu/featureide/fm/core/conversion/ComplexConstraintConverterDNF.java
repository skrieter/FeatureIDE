 ...
 * product variants. 
 * 
 * Uses the Disjunctive Normal Form (DNF) when converting.
 * 
 * @author Arthur Hammer
 */
public class ComplexConstraintConverterDNF extends ComplexConstraintConverter {

	public ComplexConstraintConverterDNF() {
		super(false);
	}
}
